...
def main(subtasks_path, task_type, work_type):
    ...
    (project_id, project_name) = ui_select_project(api, work_type)
    branch_ref = ""
    repo = ""
    branch_ref = ui_get_jira_or_branch_ref(f"{PROJECT_SHORT_NAMES[project_name]}-fix-")
    ...
    create_subtask(api, "Implement the fix", project_id, task_type, work_type, root_task_id)
